...
def load_and_preprocess_images_downscale(image_path_list, new_width=518, new_height=294, rotate=0):
    """
...
def load_and_preprocess_images(image_path_list, mode="crop", rotate=0):
    """
